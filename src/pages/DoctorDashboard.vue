            ...
            &lt;div class="mt-4">
              &lt;dl class="grid grid-cols-1 gap-4">
                &lt;div class="sm:col-span-1">
                  &lt;dt class="text-sm font-medium text-gray-500">Scheduled Appointments&lt;/dt>
                  &lt;dd class="mt-1 text-lg text-gray-900">{{ todaySummary.scheduledAppointments }}&lt;/dd>
                &lt;/div>
                &lt;div class="sm:col-span-1">
                  &lt;dt class="text-sm font-medium text-gray-500">Completed Appointments&lt;/dt>
                  &lt;dd class="mt-1 text-lg text-gray-900">{{ todaySummary.completedAppointments }}&lt;/dd>
                &lt;/div>
              &lt;/dl>
            &lt;/div>
          &lt;/div>
...
onMounted(async () => {
  // TODO: Implement API calls to fetch notifications and summary
